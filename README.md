...
> 版权声明：
> 1. 本项目为波卡黑客松参赛项目，基于 CC BY-NC 4.0 协议开源（详见 LICENSE 文件）；
> 2. 依据协议约定：任何第三方不得将本项目的代码、文档、衍生品用于商业用途，仅可用于非商业的学习、研究目的；
> 3. 项目著作权人（[whale3070/ Whale-Valut-NFT团队]）保留本项目的全部商业使用权，未经著作权人书面授权，第三方商用均构成侵权；
> 4. 违反上述约定的，著作权人将依法追究其法律责任（包括但不限于停止侵害、赔偿损失、承担维权成本等）。
